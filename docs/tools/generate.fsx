...
let githubLink = "http://github.com/heartysoft/contra"

// Specify more information about your project
let info =
  [ "project-name", "contra"
    "project-author", "ashic"
    "project-summary", "A library providing a contravariant type mapping. Types can be registered against values, and lookup honours contravariance, message envelopes, etc. Useful for messaging."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/contra" ]
